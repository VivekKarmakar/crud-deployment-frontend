...
function EditStudent() {
    ...
    useEffect(() => {
        Axios.get("https://crud-deployment-backend-0bhw.onrender.com/studentRoute/update-student/" + id)
            .then((res) => {
                if (res.status === 200) {
    ...
    const handleSubmit = () => {
        ...
        Axios.put("https://crud-deployment-backend-0bhw.onrender.com/studentRoute" + id, data)
            .then((res) => {
                if (res.status === 200)
